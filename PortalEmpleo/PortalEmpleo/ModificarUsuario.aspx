<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarUsuario.aspx.cs" Inherits="PortalEmpleo.ModificarUsuario" %>
    ...
    <form id="form1" runat="server">
        <div>
			...
			<asp:Panel ID="Filaa" runat="server" Title="">
				<asp:Label  runat="server" Text="Rut" readonly="readonly" TitleWidth="4" WebControl-Size="auto"></asp:Label>
		...
		<div>
			...
			<asp:Button ID="btnCrear" runat="server" Text="Registrar" OnClick="btnModificar_Click"/>
				<asp:Button ID="Button1" runat="server" Text="Registrar" OnClick="btnActualizar_Click"/>
